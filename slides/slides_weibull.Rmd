...
curve(2*x*exp(-x^2),from=0,to=4,add=T,col="Red")
curve(0.5*(x^(-0.5))*exp(-x^0.5),from=0,to=4,add=T,col="Purple")
legend(3,0.6,legend=c("beta=1","beta=2","beta=0.5"),col=c("Blue","Red","Purple"),lty=c(1,1,1))
```
