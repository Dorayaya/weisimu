...
test_simtrim <- function() {
  ...
  result <- simtrim(n = 5000, shape = 3, scale = 2, p = 0.0001, S = 5000)
...
test_simtrim_by <- function() {
  ...
  # Test case 5: Check if the function works when trimming proportion is a vector
  ...
  # Test case 6: Test error messages
